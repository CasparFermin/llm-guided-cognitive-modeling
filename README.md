...
The analysis files have functional reference to the [the test-set logit files]([huggingface.co/datasets/cObliUvA/llm-guided-modelling-results/tree/main](https://huggingface.co/datasets/cObliUvA/llm-guided-modelling-results/tree/main)) to reproduce the exact results of the paper.

Moreover, the fine-tuning can also be skipped, as the LoRAs can be [downloaded ](https://huggingface.co/cObliUvA/Qwen3-Coder-Next-LoRA/tree/main)to be merged with [Qwen3-Coder-Next 80B A3B](https://huggingface.co/Qwen/Qwen3-Coder-Next).
